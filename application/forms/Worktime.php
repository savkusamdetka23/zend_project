 ...
 public function __construct($options = null)
    {
		...
		$establishments_list = $establishments->getEstablishmentsList();
		$establishment_select = new Zend_Form_Element_Select('establishment_id');
        $establishment_select->setLabel('Establishment')
        ...
        $this->addElements(array($id, $establishment_select, $opening, $break_from, $break_to, $closing, $weekend, $submit));
    }
